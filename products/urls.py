...
from .views import show_products_by_price, show_products_by_category,show_three_products, review_products, add_rating, add_comment, get_ratings_comments, show_products_by_category, product_detail
app_name = 'products'
